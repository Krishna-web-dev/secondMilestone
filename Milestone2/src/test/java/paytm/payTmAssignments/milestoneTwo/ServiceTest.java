...
import paytm.payTmAssignments.milestoneTwo.Dao.RecievingUserRepository;
import paytm.payTmAssignments.milestoneTwo.Dao.SenderUserRepository;
import paytm.payTmAssignments.milestoneTwo.Dao.TransactionRepository;
import paytm.payTmAssignments.milestoneTwo.Dao.WalletRepository;
...
public class ServiceTest {
    ...
    @MockBean
    private SenderUserRepository senderRepo;
    @MockBean
    private RecievingUserRepository receiversRepo;
    ...
    void listAll_wallet() {
        ...
        wallet2.setMobilenumber("9601800819");
        wallet2.setAmount("909");
